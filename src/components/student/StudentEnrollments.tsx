...
import { CourseReview } from "./enrollments/CourseReview";
...
export const SingleEnrollmentPage: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className={`relative min-h-screen max-w-7xl mx-auto mb-10 ${theme === "light" ? "text-gray-900" : "text-gray-100 mb-5"}`}>
                <Toaster richColors position="top-center" />
                {courseData ? (
                    <div className={`relative flex flex-col lg:flex-row rounded-3xl overflow-hidden space-y-5 lg:space-y-0 lg:space-x-5 -mt-20 p-4 ${theme === "dark" ? "bg-slate-800" : "bg-gradient-to-r from-fuchsia-50 to-violet-100"}`}>
                        {/* Left Section */}
                        <div className="lg:w-2/3 rounded-xl bg-white dark:bg-gray-900">
                            <div className="mb-4 bg-violet-200 dark:bg-gray-950 rounded-t-3xl p-6">
                                <div className="flex items-center mb-2">
                                    ...
                                    />
                                    <div>
                                        <h2 className="text-lg font-bold">{courseData.instructorRef.firstName} {courseData.instructorRef.lastName}</h2>
                            ...
                            <div className="shadow-md px-4 md:px-10 py-6 mb-6 space-y-12">
                                <div className="mb-4">
                                    <h3 className="text-lg font-bold mb-2">Overview</h3>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">{courseData.description}</p>
                                </div>
                            ...
                            <div className="rounded-lg shadow-md p-4 md:p-10 mb-6">
                            ...
                            <div className="flex flex-col space-y-4 p-4 md:p-10">
                                <label htmlFor="lesson" className="ml-2 font-bold text-xl">Lessons:</label>
                                {courseData.lessons.map((lesson: any, index: number) => (
                            ...
                            <div className="flex flex-col space-y-4 p-4 md:p-10">
                                <label htmlFor="lesson" className="ml-2 font-bold text-xl">Assignments:</label>
                        ...
                        <div className="lg:w-1/3 py-4 px-6 rounded-e-3xl rounded-s-md bg-white dark:bg-gray-900 shadow-lg">
                            ...
                            <div className="p-4">
                                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
                                    <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Includes</h2>
