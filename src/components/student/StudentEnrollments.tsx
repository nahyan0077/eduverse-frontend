...
export const StudentEnrollments: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto lg:px-24 p-4">
      {isEmpty ? (
        <div className="flex flex-col items-center pt-20 mt-20 text-center">
          <Player
            autoplay
            loop
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-wrap gap-8 p-4">
            {enrollments.map((enrollment: any) => (
              <div
                key={enrollment._id}
                className="card w-full sm:w-72 glass cursor-pointer"
                onClick={() =>
