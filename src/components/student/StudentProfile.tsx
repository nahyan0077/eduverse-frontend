                    ...
                    <div className="min-h-screen flex items-center justify-center -mt-24">
                      <div className="p-8 rounded-lg shadow-lg w-full max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                          ...
                          <div className="w-full">
                            <label htmlFor="gender" className="block text-xs font-semibold mb-2">GENDER</label>
                            <Field
                              as="select"
                          ...
                          <div className="w-full">
                            <label htmlFor="profession" className="block text-xs font-semibold mb-2">PROFESSION</label>
                            <Field
                              className={inputStyle}
                              name="profession"
                          ...
                          <div className="w-full">
                            <label htmlFor="social" className="block text-xs font-semibold mb-2">SOCIAL</label>
                            <Field
                              className={inputStyle}
                              name="social"
                              placeholder="Social"
