...
export const AddLessons: React.FC = () => {
  ...
  const handleSubmit = (values: any) => {
    ...
    !isEditMode
      ...
      : navigate("/instructor/add-others", {
          state: { allData, oldData: location.state.oldData },
        });
  };
    ...
    <div className="max-w-full mx-auto py-10 px-10 text-white space-y-5">
      ...
      <div className="mb-10 flex justify-between p-4">
        <h1 className="text-3xl font-bold">
          {isEditMode ? "Edit Lessons" : "Add Lessons"}
        </h1>
      </div>
      <Formik
                ...
                <>
                        ...
                        <div className="flex collapse-content">
                          ...
                          <div className="w-[50%] p-5 space-y-7">
                            ...
                            <button
                              ...
                              onClick={() =>
                                uploadIndividualLesson(lesson, setFieldValue)
                              }>
                              Upload Lesson
                            </button>
                          </div>
                  ...
                  <div className="flex justify-end space-x-4">
                    <button
                      ...
                      onClick={() =>
                        push({
                          lessonNumber: values.lessons.length + 1,
                          title: "",
                          description: "",
                          objectives: [],
                          video: "",
