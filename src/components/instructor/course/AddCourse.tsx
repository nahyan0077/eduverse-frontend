...
export const AddCourse: React.FC = () => {
    ...
    const initialValues: CourseFirst = isEditMode && editData
        ? {
    ...
    const handleSubmit = (values: CourseFirst) => {
		...
		:
        navigate('/instructor/add-lessons', { state: { allData, oldData: editData } })
                            ...
                            <div className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex space-x-4">
                                        <button
                                            type="button"
                                            className={`btn btn-lg w-1/2 ${pricing === "free" ? "btn-success" : ""}`}
                                        ...
                                        <button
                                            type="button"
                                            className={`btn btn-lg w-1/2 ${pricing === "paid" ? "btn-error" : ""}`}
