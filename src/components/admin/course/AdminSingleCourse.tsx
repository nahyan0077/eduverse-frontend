          ...
          <div className="lg:w-2/3 p-10 rounded-xl bg-gray-50 dark:bg-gray-800">
            <div className="mb-4">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h2 className="text-lg font-bold">{courseData.instructorRef.firstName}</h2>
            ...
            <div className='flex flex-col space-y-4'>
              ...
              {courseData.lessons.map((lesson: any, index: number) => (
                <div className="collapse collapse-arrow bg-gray-100 dark:bg-gray-700 mb-2 rounded-lg" key={index}>
                  ...
                  <div className="collapse-content text-xs p-4">
                    <div className='flex space-x-3'>
                      <iframe src={lesson.video} className="w-1/2 h-48"></iframe>
                      <div>
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  <li className="flex items-center">
                    ...
                    <span>Enrolled: <strong>{courseData.students}</strong></span>
                  </li>
                  <li className="flex items-center">
                    <AccessTimeIcon className="mr-2" />
                    <span>Duration: <strong>{courseData.duration} hours</strong></span>
                  </li>
                  <li className="flex items-center">
                    <LibraryBooksIcon className="mr-2" />
                    <span>Chapters: <strong>{courseData.lessons.length}</strong></span>
                  </li>
                  <li className="flex items-center">
                    <BoltIcon className="mr-2" />
                    <span>Level: <strong>{courseData.level}</strong></span>
                  </li>
                </ul>
              </div>
            </div>
