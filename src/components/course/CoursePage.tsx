...
import { CourseEntity, Lesson } from "@/types/ICourse"; // Ensure Lesson type is imported
...
export const CoursePage: React.FC = () => {
    ...
    const calculateTotalDuration = (lessons: Lesson[]) => {
        return lessons
            .filter(lesson => lesson.duration !== undefined) // Filter out lessons without a duration
            .reduce((total, lesson) => total + parseFloat(lesson.duration!), 0); // Use non-null assertion operator
    };
                            ...
                            <div key={course._id} className="card shadow-xl">
                                ...
                                <div className="card-body fixed-height">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Instructor: {course.instructorRef}
                                    </p>
                                    <p className="text-sm text-gray-500">
