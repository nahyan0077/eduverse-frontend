...
export const ChatWindow: React.FC<ChatWindowProps> = ({ messages, currentUser, onSendMessage }) => {
    return (
        <section className="hidden lg:flex flex-col w-2/3 bg-gray-900">
            <header className="flex items-center p-4 border-b border-gray-800">
                ...
                <div>
                    <div className="font-bold text-white">Demo User 1</div>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="border-t border-gray-800 p-4">
                    <div className="flex items-center bg-gray-800 rounded-lg">
                        ...
                        />
                        <button className="p-2 text-gray-400 hover:text-blue-500" onClick={onSendMessage}>
                            <IoIosSend size={"30px"} />
                        </button>
                        <button className="p-2 text-gray-400 hover:text-blue-500">
