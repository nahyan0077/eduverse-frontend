    ...
    <section className={` py-12`}>
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className={`text-3xl font-bold ${theme === 'light' ? 'text-violet-700' : 'text-violet-700'}`}>Meet Our <span className={`${theme === 'light' ? 'text-gray-900' : 'text-white'}`} > Mentors </span> </h2>
