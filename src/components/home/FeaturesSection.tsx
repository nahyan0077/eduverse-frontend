		...
		<>
			...
			<div className="flex mx-auto flex-col-reverse lg:flex-row max-w-7xl justify-center">
				...
				<div className="flex flex-col items-center w-full lg:w-1/2 md:mt-32">
					<h1 className="text-violet-700 text-2xl font-bold">
						<span className="text-blue-950 text-2xl font-bold">Tools</span> For
			...
			<div className="flex mx-auto flex-col-reverse lg:flex-row max-w-7xl justify-center">
				<div className="flex flex-col items-center w:full lg:w-1/2 md:mt-32">
					<h1 className="text-violet-700 text-2xl font-bold">
						Assessments,
						<span className="text-blue-950 text-2xl font-bold"> Quizzes,</span>{" "}
						Tests
					</h1>
					<p className="text-gray-500 font-thin w-96 p-4">
			...
			<div className="flex flex-col max-w-7xl mx-auto lg:flex-row justify-center items-center bg-gray-100 mt-5 mb-5 rounded-xl p-5">
				...
				<div className="w:full lg:w-1/2">
					...
					<p className="mt-5 text-gray-400 text-center">
						...
						learning. Elevate your skills, career, and interests with us. Unlock
						endless learning possibilities now!
					</p>
